...
export declare const models: {
    ...
    bedrock: {
        ...
        supportsJSON: never[];
        supportsImages: readonly ["anthropic.claude-3-sonnet-20240229-v1:0", "anthropic.claude-3-opus-20240229-v1:0", "anthropic.claude-3-haiku-20240307-v1:0"];
        supportsToolCalls: readonly ["anthropic.claude-3-opus-20240229-v1:0", "anthropic.claude-3-sonnet-20240229-v1:0", "anthropic.claude-3-haiku-20240307-v1:0", "cohere.command-r-plus-v1:0", "cohere.command-r-v1:0", "mistral.mistral-large-2402-v1:0"];
        supportsN: boolean;
        generateDocs: boolean;
    };
    mistral: {
